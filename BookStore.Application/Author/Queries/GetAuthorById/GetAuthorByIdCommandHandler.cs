...
public class GetAuthorByIdCommandHandler : IRequestHandler<GetAuthorByIdCommand, Domain.Entities.Author>
{
    ...
    public async Task<Domain.Entities.Author> Handle(GetAuthorByIdCommand request, CancellationToken cancellationToken)
    {
